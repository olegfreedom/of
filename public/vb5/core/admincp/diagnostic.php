...
define('CVS_REVISION', '$RCSfile$ - $Revision: 76989 $');
define('NOZIP', 1);
...
if ($_POST['do'] == 'doversion')
{
	...
	if ($handle)
	{
		...
		$md5_sum_versions = array('vbulletin' => '5.0.5');
...
if ($_REQUEST['do'] == 'server_modules')
{
	...
	print_label_row($vbphrase['mod_security_ajax_issue'], "<span id=\"mod_security_test_result\">$vbphrase[no]</span><img src=\"". $vbulletin->options['bburl'] . '/' . $vb5_config['Misc']['admincpdir'] . "/clear.gif?test=%u0067\" id=\"mod_security_test\" alt=\"\" />");
