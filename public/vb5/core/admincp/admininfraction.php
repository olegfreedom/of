...
define('CVS_REVISION', '$RCSfile$ - $Revision: 76281 $');
...
if ($_REQUEST['do'] == 'dolist')
{
	...
	if ($infractions AND $infractions->valid())
	{
		...
		$headings[] = "<a href=\"admininfraction.php?" . vB::getCurrentSession()->get('sessionurl') . "do=dolist" . $args . "reputation_penalty\" title=\"" . $vbphrase['order_by_reputation_penalty'] . "\">" . $vbphrase['reputation_penalty'] . "</a>";
