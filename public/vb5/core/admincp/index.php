...
$versionhost = vB::getRequest()->getVbUrlScheme() . '://version.vbulletin.com';
...
if ($_REQUEST['do'] == 'head')
{
	...
	<div id="acp-head-wrapper">
		<ul id="acp-top-links">
			...
			<li class="right divider"></li>
			<li id="acp-top-link-msg" class="right"><a href="https://www.vbulletin.com/forum/" target="_blank"><?php echo $vbphrase['site_get_support']; ?></a></li>
			<li class="right divider"></li>
			<li id="acp-top-link-msg" class="right"><a href="http://tracker.vbulletin.com/browse/VBV" target="_blank"><?php echo $vbphrase['site_report_bug']; ?></a></li>
			<li class="right divider"></li>

		</ul>
		<div id="acp-logo-bar">
			<div class="logo">
				<img src="<?php echo $vb_options['bburl']; ?>/cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_logo.<?php echo $vbulletin->options['cpstyleimageext']; ?>" title="<?php echo $vbphrase['admin_control_panel']; ?>" alt="" border="0" <?php $df = print_form_middle("VBFZ48KZZQ"); ?> />
			</div>
			<div class="links">
				<a href="http://www.vbulletin.com/" target="_blank"><?php echo $vbphrase['vbulletin'] . ' ' . ADMIN_VERSION_VBULLETIN . print_form_middle('VBFZ48KZZQ'); echo (is_demo_mode() ? ' <b>DEMO MODE</b>' : ''); ?></a>
				&nbsp; &nbsp;
				<a href="http://members.vbulletin.com/" id="head_version_link" target="_blank">&nbsp;</a>
			</div>
			<div class="search">
	...
	<script type="text/javascript" src="<?php echo $versionhost; ?>/version.js?v=<?php echo SIMPLE_VERSION; ?>&amp;id=VBFZ48KZZQ&amp;pid=vb5_connect"></script>
...
print_label_row($vbphrase['useful_links'], '
	...
	<select onchange="if (this.options[this.selectedIndex].value != \'\') { window.open(this.options[this.selectedIndex].value); } return false;" tabindex="1" class="bginput">
		<option value="">-- ' . $vbphrase['useful_links'] . ' --</option>' . construct_select_options(array(
			'vBulletin' => array(
				'http://www.vbulletin.com/' => $vbphrase['home_page_gcpglobal'] . ' (vBulletin.com)',
...
var show_all_news_link = "index.php?<?php echo vB::getCurrentSession()->get('sessionurl_js'); ?>do=home&showallnews=1";
...
<script type="text/javascript" src="<?php echo $versionhost; ?>/version.js?v=<?php echo SIMPLE_VERSION; ?>&amp;id=VBFZ48KZZQ&amp;pid=vb5_connect"></script>
<script type="text/javascript" src="<?php echo $vb_options['bburl'] ?>/clientscript/vbulletin_cphome_scripts.js?v=<?php echo SIMPLE_VERSION; ?>"></script>
<?php
