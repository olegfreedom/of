...
define('CVS_REVISION', '$RCSfile$ - $Revision: 76607 $');
...
if ($_POST['do'] == 'update')
{
	...
	if (!empty($homePerms) AND !empty($homePerms[$resultUg]))
	{
		...
		$fmcPermissions['forumpermissions2'] = array();
	...
	*/
	...
	foreach ($siteNavs AS $k => &$item)
	{
		...
		if (!empty($item['phrase']) AND $item['phrase'] === 'navbar_blogs')
		{
