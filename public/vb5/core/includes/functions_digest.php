...
function exec_digest($type = 2)
{
	...
	foreach ($threads AS $thread)
	{
		if ($thread['languageid'] == 0)
		{
			if (!$defaultLanguage)
			{
				$languageIds[] = intval(vB::getDatastore()->getOption('languageid'));
			}
		}
		else 
		{
	...
	foreach ($threads as $thread)
	{
		...
		$thread['lastreplydate'] = vbdate($langInfo['dateoverride'] ? $langInfo['dateoverride'] : vB::getDatastore()->getOption('default_dateformat'), $thread['lastcontent'], false, true, true, false, $userinfo);
		$thread['lastreplytime'] = vbdate($langInfo['timeoverride'] ? $langInfo['timeoverride'] : vB::getDatastore()->getOption('default_timeformat'), $thread['lastcontent'], false, true, true, false, $userinfo);
		...
		foreach ($posts as $post)
		{
			...
			$post['postdate'] = vbdate($langInfo['dateoverride'] ? $langInfo['dateoverride'] : vB::getDatastore()->getOption('default_dateformat'), $post['publishdate'], false, true, true, false, $userinfo);
			$post['posttime'] = vbdate($langInfo['timeoverride'] ? $langInfo['timeoverride'] : vB::getDatastore()->getOption('default_timeformat'), $post['publishdate'], false, true, true, false, $userinfo);
	...
	foreach ($forums as $forum)
	{
		...
		foreach ($threads AS $thread)
		{
			...
			$thread['lastreplydate'] = vbdate($langInfo['dateoverride'] ? $langInfo['dateoverride'] : vB::getDatastore()->getOption('default_dateformat'), $thread['lastpost'], false, true, true, false, $userinfo);
			$thread['lastreplytime'] = vbdate($langInfo['timeoverride'] ? $langInfo['timeoverride'] : vB::getDatastore()->getOption('default_timeformat'), $thread['lastpost'], false, true, true, false, $userinfo);
