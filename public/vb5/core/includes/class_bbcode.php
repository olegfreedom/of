...
*
* @package 		vBulletin
* @version		$Revision: 76917 $
* @date 		$Date: 2013-08-14 16:49:57 -0700 (Wed, 14 Aug 2013) $
*
*/
...
//					$dobbcode = $forum['allowbbcode'];
	...
	*/
	function handle_bbcode_sigpic($description)
	{
		...
		$sigpic_url = vB::getDatastore()->getOption('frontendurl') . '/filedata/fetch?filedataid=' . $this->parse_userinfo['sigpic']['filedataid'] . '&amp;sigpic=1';
