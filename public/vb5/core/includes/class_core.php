...
define('FILE_VERSION', '5.0.5'); // this should match installsteps.php
if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '505'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 77711 $
* @date		$Date: 2013-09-24 10:32:39 -0700 (Tue, 24 Sep 2013) $
*/
