...
*
* @package	vBulletin
* @version	$Revision: 77175 $
* @date		$Date: 2013-08-29 12:11:09 -0700 (Thu, 29 Aug 2013) $
*/
...
abstract class vB_StyleVar
{
	...
	protected function fetch_stylevar_input($stylevarid, $input_type, $stylevar_value)
	{
		...
		if (self::$need_stylevar_autocomplete_js == true)
		{
			...
			$autocomplete_js .= "\n<script type=\"text/javascript\" src=\"" . vB::getDatastore()->getOption('bburl') .
				"/../js/jquery/jquery-ui-1.8.14.custom.min.js?v=" . SIMPLE_VERSION . "\"></script>\n\r" .
	...
	protected function print_color_input_row($title, $stylevarid, $color_value, $stylevar_value)
	{
		...
		if (self::$need_colorpicker)
		{
			...
			$cp = '<script type="text/javascript" src="' . vB::getDatastore()->getOption('bburl') .
...
class vB_StyleVar_textdecoration extends vB_StyleVar
{
	public function print_editor_form()
	{
		...
		$this->print_yes_no_row($vbphrase['blink'], $this->stylevarid, 'blink', $this->value['blink'], $this->value['stylevar_blink']);
	}
}
