...
function construct_color_picker($size = 12, $display = 'none')
{
	...
	<tr>
		<td><button onclick=\"col_click('transparent'); return false\"><img src=\"" . $vbulletin->options['bburl'] . "/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/colorpicker_transparent.gif\" title=\"'transparent'\" alt=\"\" /></button></td>
		<td>
		...
		<td style=\"white-space:nowrap\">
			...
			<button onclick=\"switch_color_picker(1); return false\"><img src=\"" . $vbulletin->options['bburl'] . "/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/colorpicker_toggle.gif\" alt=\"\" /></button>
			<button onclick=\"close_color_picker(); return false\"><img src=\"" . $vbulletin->options['bburl'] . "/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/colorpicker_close.gif\" alt=\"\" /></button>
		</td>
	</tr>
	</table>
...
function activateCodeMirror($ids)
{
	...
	?>
				...
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/search/search.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/search/searchcursor.js?v=<?php echo SIMPLE_VERSION ?>"></script>
