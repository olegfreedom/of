...
function print_cp_header($title = '', $onload = '', $headinsert = '', $marginwidth = 0, $bodyattributes = '')
{
	...
	<script type=\"text/javascript\" src=\"$filebase/../js/jquery/jquery-" . JQUERY_VERSION . ".min.js\"></script>\n\r";
	echo "</head>\r\n";
...
function cache_forum_permissions($permissions = array(), $parentid = 1)
{
	...
	$channels = vB::getDbAssertor()->assertQuery('vBForum:node', array(vB_dB_Query::TYPE_KEY => vB_dB_Query::QUERY_SELECT,
		'parentid' => $parentid, 'contenttypeid' => vB_Types::instance()->getContentTypeID('vBForum_Channel')));
